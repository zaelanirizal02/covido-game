...
public class GerakanNPC : MonoBehaviour
{
    [Header("Kecepatan")]
    ...
    void Duduk()
    {
        ...
        animator.SetFloat("Duduk", moveAnim, 0.1f, Time.deltaTime);
        ...
        Vector3 duduk = new Vector3(moveX,  -1, moveZ);
        duduk = transform.TransformDirection(duduk);

        if (moveX == 0 && moveZ == 0) duduk = Vector2.zero;
       
        characterController.Move(duduk * kecepatan * Time.deltaTime);
